...
public class NTGEncryptor
{
    ...
    final static String secretKey="Hsjytv hggi hgu/dl";
...
//        String enc=NTGEncryptor.encrypt( plain);
//        System.out.println("Original text: "+plain);
//        System.out.println("Encrypted text: "+enc);
//        String plainAfter=NTGEncryptor.decrypt( enc);
